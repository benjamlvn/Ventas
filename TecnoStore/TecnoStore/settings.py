"""
Django settings for TecnoStore project.
...
SECRET_KEY = 'django-insecure-5pi=2r--@=c!28xw-a1!rai=9*m$-kus8e$r*3zvlujqsdf9*&'
...
WSGI_APPLICATION = 'TecnoStore.wsgi.application'
